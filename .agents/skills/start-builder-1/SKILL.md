...
This lesson stages no assets and writes no files at setup. The student just arrived here from the Builder Bridge: they cloned this repo, opened it as a new project, and started a fresh chat.

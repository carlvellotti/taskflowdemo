...
name: grill-me
description: |
  Spec interview skill that turns a rough vision into a complete feature
...
- **ALWAYS present every question as a lettered text menu.** Never ask questions in plain paragraph form. For each question, offer the likely answers as a lettered list ((a), (b), (c)…, one option per line) plus a final "something else, tell me what you're thinking" option, and tell the student to reply with the letter. If a question genuinely calls for open prose, still frame it as a lettered choice of directions with the open option last. This is non-negotiable, the structured format is faster for the student and keeps the interview moving.

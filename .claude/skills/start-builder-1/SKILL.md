...
This lesson stages no assets and writes no files at setup. The student just arrived here from the Builder Bridge: they cloned this repo, opened it as its own project, and started a fresh session.
